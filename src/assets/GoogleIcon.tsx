...
export function GoogleIcon(props: GoogleIconProps) {
  ...
  return (
    <SvgIcon
      ...
      {...rest}
    >
      <title id="title90">btn_google_light_normal_ios</title>
      <desc id="desc92">Created with Sketch.</desc>
      <defs id="defs116">
        <filter
          x="-0.059999999"
          y="-0.059999999"
        ...
        >
          ...
          <feMerge id="feMerge112">
            <feMergeNode in="shadowMatrixOuter1" id="feMergeNode106" />
            <feMergeNode in="shadowMatrixOuter2" id="feMergeNode108" />
            <feMergeNode in="SourceGraphic" id="feMergeNode110" />
          </feMerge>
        </filter>
      ...
      >
        <g id="logo_googleg_48dp" transform="translate(14,14)">
          <path
          ...
          <path
            ...
            fill="#ea4335"
          />
          <path d="M 0,0 H 18 V 18 H 0 Z" id="path136" />
        </g>
      </g>
    </SvgIcon>
  );
